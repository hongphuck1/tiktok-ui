export const IconUpload = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const IconInbox = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const IconMessage = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const IconSearch = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const IconClearBtn = ({ width = '1.3rem', height = '1.3rem', color, className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const IconLoadBtn = ({ width = '1.3rem', height = '1.3rem', color, className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const IconTick = ({ width = '2rem', height = '2rem', color, className }) => (
    <svg
        width={width}
        height={height}
        className={className}
